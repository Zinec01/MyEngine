...
internal class Program
{
    static void Main(string[] args)
    {
        ...
        app.MainWindow.OnLoad += (sender, args) =>
        {
            ...
            var program = ShaderManager.GetShaderProgram("Basic",
                                                         @"C:\Users\Zinec\source\repos\MyEngine\MyEngine\Shaders\basic_light.vert",
                                                         @"C:\Users\Zinec\source\repos\MyEngine\MyEngine\Shaders\basic_light.frag");
        };
        app.Run();
